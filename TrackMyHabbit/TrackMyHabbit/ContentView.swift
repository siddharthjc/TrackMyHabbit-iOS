...
struct ContentView: View {
    ...
    private func deleteEntry(for habit: Habit, dateStr: String) {
        do {
            try HabitEntryStore.deleteEntries(habit: habit, dateString: dateStr, modelContext: modelContext)
        } catch {
    ...
    private func savePhoto(for habit: Habit, dateStr: String, data: Data) {
        do {
            try HabitEntryStore.savePhoto(data, habit: habit, dateString: dateStr, modelContext: modelContext)
        } catch {
